...
var CoolEnv = /** @class */ (function () {
    function CoolEnv() {
    }
    CoolEnv.prototype.getEnv = function () {
        var localHost = location.hostname.indexOf('local');
        var devHost = location.hostname.indexOf('dev');
    ...
    CoolEnv.prototype.getEnvPrefix = function () {
        var prefix = '';
        var env = this.getEnv();
        switch (env) {
            case "prod":
