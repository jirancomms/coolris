    ...
    getLinkTemplate(serviceName: string, gaMeasurementId: string) {
        return `
            ...
            <div coolrisLink>
                ...
                <a onclick="gtag('event', '${serviceName}', {'event_category': 'link', 'event_label': 'support', 'send_to': '${gaMeasurementId}'});" href="//www.coolschool.co.kr/messenger/technicalSupport/qna" target="_blank">기술문의</a>
            </div>
        `
    }
    ...
    getInfoTemplate(serviceName: string, gaMeasurementId: string) {
        return `
            ...
            <section coolrisInfo>
                ...
                window.open('http://www.coolschool.co.kr/contract/privacy?type=html', 'coolschool_privacy', 'width=500,height=350');" class="privacy">개인정보처리방침</span></p>
