...
class Coolris {
    ...
    coolrisTemplate() {
        ...
        <script>
            ...
            })(window,document,'script','https://www.google-analytics.com/analytics.js','coolris_ga');
    
            coolris_ga('create', 'UA-119402731-1', 'auto');
            coolris_ga('send', 'pageview');
            
        </script>
        <div class="dropdown" coolris>
            <span onclick="coolris_ga('send','event','link','click', 'coolris-coolfamily')" class="dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="dropdown-menu pt-2" aria-labelledby="dropdownMenuButton">
                ...
                <div class="pl-4 pr-4 clearfix">
                    <a onclick="coolris_ga('send','event','link','click', 'coolris-coolschool')" class="col-6 float-left p-0" href="http://www.coolschool.co.kr/">
                        <span class="img">
                    ...
                    <a onclick="coolris_ga('send','event','link','click', 'coolris-samstory')" class="col-6 float-left p-0" href="http://samstory.coolschool.co.kr">
                        <span class="img">
                ...
                <div class="pl-4 pr-4 clearfix">
                    <a onclick="coolris_ga('send','event','link','click', 'coolris-coolbooks')" class="col-6 float-left p-0" href="https://coolbooks.coolschool.co.kr/">
                        <span class="img">
                    ...
                    <a onclick="coolris_ga('send','event','link','click', 'coolris-ourschoolBook')" class="col-6 float-left p-0" href="https://school.coolbooks.co.kr/">
                        <span class="img">
                ...
                <div class="pl-4 pr-4 clearfix">
                    <a onclick="coolris_ga('send','event','link','click', 'coolris-weteacher')" class="col-6 float-left p-0" href="http://weteacher.coolschool.co.kr/">
                        <span class="img">
                    ...
                    <a onclick="coolris_ga('send','event','link','click', 'coolris-coolissue')" class="col-6 float-left p-0" href="http://issue.coolschool.co.kr">
                        <span class="img">
                ...
                <div class="pl-4 pr-4 clearfix">                    
                    <a onclick="coolris_ga('send','event','link','click', 'coolris-coolmessenger')" class="col-6 float-left p-0" href="http://school.coolmessenger.com/">
                        <span class="img">
                    ...
                    <a onclick="coolris_ga('send','event','link','click', 'coolris-cooledu')" class="col-6 float-left p-0" href="http://cooledu.coolschool.co.kr">
                        <span class="img">
                ...
                <div class="bottom pb-3 pt-2">
                    <div class="pl-4 pr-4 clearfix">
                        <a onclick="coolris_ga('send','event','link','click', 'coolris-coolview')" class="col-6 float-left p-0" href="https://coolview.coolschool.co.kr">
                            <span class="img">
                        ...
                        <a onclick="coolris_ga('send','event','link','click', 'coolris-coolnote')" class="col-6 float-left p-0" href="http://coolnote.coolschool.co.kr/">
                            <span class="img">
                    ...
                    <div class="pl-4 pr-4 clearfix">
                        <a onclick="coolris_ga('send','event','link','click', 'coolris-coolmova')" class="col-6 float-left p-0" href="http://coolmova.coolschool.co.kr/">
                            <span class="img">
                        ...
                        <a onclick="coolris_ga('send','event','link','click', 'coolris-coolsms')" class="col-6 float-left p-0" href="https://coolsms.coolmessenger.com">
                            <span class="img">
    ...
    coolProfileTemplate() {
        return `
            ...
            <span onclick="coolris_ga('send','event','link','click', 'coolProfile-profile')" class="dropdown-toggle" type="button" id="coolProfileDropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="dropdown-menu" aria-labelledby="coolProfileDropdownMenuButton">
                ...
                <div>
                    내 쿨포인트
                    <a onclick="coolris_ga('send','event','link','click', 'coolProfile-coolpoint')" href="//point.coolschool.co.kr" target="_blank">
                        <img src="http://update.coolmessenger.com/_ImageServer/coolschool/resources/images/point.png" alt="point" />   
                        1,345원         
                    </a>
                </div>
                <span onclick="coolris_ga('send','event','link','click', 'coolProfile-logout')" class="logout">로그아웃</span>
            </div>
        </div>
        `
    }
